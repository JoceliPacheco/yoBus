...
class ListaBox extends StatefulWidget {
  final List<Hora> lista;
  ListaBox(this.lista);

  @override
  _ListaBoxState createState() => _ListaBoxState();
}

class _ListaBoxState extends State<ListaBox> {
      ...
      children: <Widget>[
        ListView.builder(
            ...
            itemBuilder: (context, index) {
              final Hora linha = widget.lista[index];
...
class notFound extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      child: Center(
        child: Text('Nenhum resultado localizado!'),
      ),
    );
  }
}
